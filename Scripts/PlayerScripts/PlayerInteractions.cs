...
public class PlayerInteractions : MonoBehaviour
{
    ...
    private UIBatteryUpdater batteryUpdater;
    ...
    void Start()
    {
        ...
        batteryUpdater = FindObjectOfType<UIBatteryUpdater>();
    ...
    void GetStringID(RaycastHit hit)
    {
        ...
        switch (targetID)
        {
            ...
            case "Battery":
                ...
                batteryUpdater.UpdateBatteryPercentage();
                break;
            ...
            case "Container":
                ...
                if (container.HasItem())
                {
                    ...
                    uiInventory.UpdateText(itemNum, FilterStringType(itemType));
                }
            ...
            case "Keypad":
                interactableObject.GetComponent<Keypad>().InteractKeypad();
                break;

            // Ending ---------------------------------------

            case "Ending":
                interactableObject.GetComponent<EndingDoors>().InitiateEnding();
                break;
    ...
    void DrainBattery()
    {
        ...
        batteryUpdater.UpdateBatteryPercentage(); // update text
    ...
    {
        playerInventory.AddResourceItem(type, value);
    }
    #endregion
